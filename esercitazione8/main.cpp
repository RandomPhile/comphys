...
int main() {
    ...
    parametri_funz[1]=0;
    parametri_funz[2]=1;
    par_distr[0]=0;//inizio
    par_distr[1]=1;//fine
    par_distr[2]=1;//sigma distr
    par_distr[3]=0;//mu distr
    par_g[0]=par_distr[2];
    par_g[1]=par_distr[3];
    //cout<<"integrale sin^2x "<<integrale_montecarlo(sin_n, parametri_funz, distr_gauss, par_distr, delta, gauss, par_g)<<endl;

    cout<<integrale_montecarlo(mod_ex,parametri_funz, distr_gauss, par_distr, delta, gauss, par_g)<<endl;
