...
#set xrange [0:3]
unset logscale x
plot "dati.dat" i 0 u 5:6 w l lt rgb "red"   title columnheader(1),\
	 "dati.dat" i 1 u 5:6 w l lt rgb "blue"  title columnheader(1), \
	 "dati.dat" i 2 u 5:6 w l lt rgb "black" title columnheader(1)
unset xrange
set logscale x
